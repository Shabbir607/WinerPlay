        ...
        <nav class="navbar">
            ...
            @auth
                @if(Auth::user()->role_id == 1)
                    <a href="{{ route('dashboard') }}" target="_blank" class="navbar-link">dashboard</a>
                @elseif(Auth::user()->role_id == 2)
                    <a href="{{ route('user.home') }}" target="_blank" class="navbar-link">dashboard</a>
                @endif
            @else
                <a href="{{ route('login.form') }}" target="_blank" class="navbar-link">Join Us</a>
            @endauth
