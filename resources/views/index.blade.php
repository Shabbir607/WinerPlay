...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Categories -->
        <li class="nav-item">
            <a class="nav-link collapsed" href="{{ route('/category')}}" data-toggle="collapse"
        ...
        {{-- Products --}}
        <li class="nav-item">
            <a class="nav-link collapsed" href="{{ route('/product')}}" data-toggle="collapse"
        ...
        <li class="nav-item">
            ...
            <div id="brandCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{ route('/brand')}}">Brands</a>
                            ...
                            <div class="col-8">
                                <div class="numbers">
                                    ...
                                    <h5 class="font-weight-bolder mb-0">
                                        ${{ number_format($investmentData['todayTotalInvestment'], 2) }}
                                        <span class="{{ $investmentData['percentageChange'] > 0 ? 'text-success' : 'text-danger' }} text-sm font-weight-bolder">{{ $investmentData['percentageChange'] > 0 ? '+' : '' }}{{ number_format($investmentData['percentageChange'], 2) }}%</span>
                                    </h5>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    ...
                                    <h5 class="font-weight-bolder mb-0">
                                        {{ $userData['todayTotalUsers'] }}
                                        <span class="{{ $userData['percentageChange'] > 0 ? 'text-success' : 'text-danger' }} text-sm font-weight-bolder"> {{ $userData['percentageChange'] > 0 ? '+' : '' }}{{ number_format($userData['percentageChange'], 2) }}%</span>
                                    </h5>
                                </div>
                            </div>
                            <div class="col-4 text-end">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    ...
                                    <h5 class="font-weight-bolder mb-0">
                                        {{ $memberData['todayNewClients'] > 0 ? '+' : '' }}{{ $memberData['todayNewClients'] }}
                                        <span class="{{ $memberData['percentageChange'] > 0 ? 'text-success' : 'text-danger' }} text-sm font-weight-bolder">{{ $memberData['percentageChange'] > 0 ? '+' : '' }}{{ number_format($memberData['percentageChange'], 2) }}%</span>
                                    </h5>
                                </div>
                            </div>
                            <div class="col-4 text-end">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    ...
                                    <h5 class="font-weight-bolder mb-0">
                                        ${{ number_format($totalInvestment['totalInvestment'], 0) }}
                                        <span class="{{ $totalInvestment['percentageChange'] > 0 ? 'text-success' : 'text-danger' }} text-sm font-weight-bolder">{{ number_format($totalInvestment['percentageChange'], 2) }}%</span>
                                    </h5>
                                </div>
                            </div>
                            <div class="col-4 text-end">
                        ...
                        <div class="container border-radius-lg">
                            <div class="row">
                                ...
                                <div class="col-3 py-3 ps-0">
                                    ...
                                    <h4 class="font-weight-bolder">{{ number_format($totalInvestment['totalInvestment'], 0) }}$
                                    </h4>
                                    <div class="progress w-75">
                                        <div  class="progress-bar bg-dark" role="progressbar" style="width: {{ number_format($totalInvestment['totalInvestment'], 0) }}%;" aria-valuenow="{{ number_format($totalInvestment['totalInvestment'], 0) }}" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                                <div class="col-3 py-3 ps-0">
                                    <div class="d-flex mb-2">
                                    ...
                                    <div class="progress w-75">
                                        <div class="progress-bar bg-dark" role="progressbar" style="width: {{ $items }}%;" aria-valuenow="{{ $items }}" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row align-items-center justify-content-lg-between">
                    <div class="col-lg-6 mb-lg-0 mb-4">
                        <div class="copyright text-center text-sm text-muted text-lg-start">
                            ...
                            made by
                            <a href="#" class="font-weight-bold" target="_blank">Shabbir</a>
