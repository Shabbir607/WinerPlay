    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" action="{{ route('products.update', ['id' => $product->id]) }}"enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="admin_phone" class="col-form-label">Phone Number<span class="text-danger">*</span></label>
                    <input id="admin_phone" type="number" name="admin_phone" placeholder="Enter Phone" value="{{old('admin_phone')}}" class="form-control">
                    @error('admin_phone')
                    <span class="text-danger">{{$message}}</span>
                    @enderror
                </div>
