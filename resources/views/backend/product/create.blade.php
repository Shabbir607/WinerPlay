        ...
        <div class="card-body">
            <form method="post" action="{{ route('/product.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input id="location" type="text" name="location" placeholder="Enter location" class="form-control">
                    @error('location')
                    <span class="text-danger">{{$message}}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input id="stock" type="number" name="stock" placeholder="Enter stock" class="form-control">
                    @error('stock')
                    <span class="text-danger">{{$message}}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    <label for="opening_date" class="col-form-label">Opening Date <span
                            class="text-danger">*</span></label>
                ...
                <div class="form-group">
                    <label for="price_per_share" class="col-form-label">Price per Share <span
                            class="text-danger">*</span></label>
                    <input id="price_per_share" type="number" name="price_per_share" placeholder="Enter price per share"
                           class="form-control">
                ...
                <div class="form-group">
                    ...
                    <input type="checkbox" name="is_featured" id="is_featured"> Yes
                </div>

                <div class="form-group">
                    <label for="tags" class="col-form-label">Tags</label>
                    <input id="tags" type="text" name="tags" placeholder="Enter tags" class="form-control">
                    @error('tags')
                    <span class="text-danger">{{$message}}</span>
                    @enderror
                </div>
